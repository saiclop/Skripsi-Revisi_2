 ...
 */
UCLASS()
class SKRIPSI_API UAsyncActionNode : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	{
		RETURN_QUICK_DECLARE_CYCLE_STAT(BP_NonAbondonableTask, STATGROUP_ThreadPoolAsyncTasks);
	}
